...
statement:
          defStatement                                                                                                  #defS
        | ifStatement                                                                                                   #ifS
        | returnStatement NEWLINE                                                                                       #returnS
        | printStatement NEWLINE                                                                                        #printS
        | assignStatement NEWLINE                                                                                       #assignS
        | forStatement                                                                                                  #forS
        | whileStatement                                                                                                #whileS
        | functionCallStatement NEWLINE                                                                                 #functionCallS
        | expressionStatement NEWLINE                                                                                   #expressionS;
...
assignStatement: IDENTIFIER ASSIGN expression                                                                           #assignStatementAST;
...
functionCallStatement: primitiveExpression PIZQ expressionList PDER                                                     #functionCallStatementAST;
expressionStatement: expressionList                                                                                     #expressionStatementAST;
...
NUMBER  : SUB? (INTEGER | FLOAT_NUMBER) ;
...
fragment SHORT_BYTES : '\'' ( SHORT_BYTES_CHAR_NO_SINGLE_QUOTE | BYTES_ESCAPE_SEQ )* '\'' | '"' ( SHORT_BYTES_CHAR_NO_DOUBLE_QUOTE | BYTES_ESCAPE_SEQ )* '"' ;
